...
const pageMeta: Record<string, PageMeta> = {
  '/': {
    title: 'Unlink SG — cancel a SIM or move house without losing accounts',
    description:
  ...
  '/cancel-sim': {
    title: 'Cancelling a Singapore mobile number — full checklist | Unlink SG',
    description:
  ...
  '/moving': {
    title: 'Change of address Singapore — moving house checklist | Unlink SG',
    description:
  ...
  '/report': {
    title: 'Receiving SMS meant for your number’s previous owner? | Unlink SG',
    description:
